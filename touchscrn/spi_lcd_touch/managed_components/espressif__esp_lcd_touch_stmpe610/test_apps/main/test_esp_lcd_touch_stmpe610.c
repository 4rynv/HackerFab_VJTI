...
#define TEST_PIN_NUM_SCLK           10
#define TEST_PIN_NUM_MOSI           7
#define TEST_PIN_NUM_MISO           6
#define TEST_PIN_NUM_TOUCH_CS       1

#define TEST_LCD_H_RES              (240)
#define TEST_LCD_V_RES              (240)

/* LCD touch pins */
#define TEST_TOUCH_I2C_SCL       (GPIO_NUM_5)
#define TEST_TOUCH_I2C_SDA       (GPIO_NUM_4)
