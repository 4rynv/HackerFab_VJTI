...
#define TEST_PIN_NUM_LCD_CS         (GPIO_NUM_2)   // EXAMPLE_PIN_NUM_LCD_CS
#define TEST_PIN_NUM_LCD_PCLK       (GPIO_NUM_10)  // EXAMPLE_PIN_NUM_SCLK
#define TEST_PIN_NUM_LCD_DATA0      (GPIO_NUM_7)   // EXAMPLE_PIN_NUM_MOSI
#define TEST_PIN_NUM_LCD_DC         (GPIO_NUM_5)   // EXAMPLE_PIN_NUM_LCD_DC
#define TEST_PIN_NUM_LCD_RST        (GPIO_NUM_4)   // EXAMPLE_PIN_NUM_LCD_RST
#define TEST_PIN_NUM_LCD_BL         (GPIO_NUM_3)   // EXAMPLE_PIN_NUM_BK_LIGHT
